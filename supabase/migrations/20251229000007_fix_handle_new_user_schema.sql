-- Fix handle_new_user to use explicit schema when calling create_wallet_for_user
...
BEGIN
    ...
    -- Create wallet for the new user (with explicit schema)
...
COMMENT ON FUNCTION public.handle_new_user IS 'Trigger function for new user signup: auto-confirms email, creates profile, creates wallet (with explicit schema references)';
