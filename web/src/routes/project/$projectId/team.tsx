...
function PersonCard({
	...
	return (
		<div
			className={`group relative flex flex-col border border-gray-100 overflow-hidden shadow-sm hover:shadow-md transition-shadow bg-white rounded-lg ${className ?? ""}`}
		>
...
function PrincipalsCard({ project }: { project: Project }) {
	...
	return (
		<div className="col-span-full lg:col-span-3 rounded-xl border-2 border-dashed border-gray-300 bg-gray-50/70 p-2.5">
