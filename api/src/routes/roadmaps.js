 ...
 */
router.get("/:id/full", verifySupabaseJwt, readLimiter, async (req, res, next) => {
  try {
    const { id } = req.params;
 ...
 * Update a roadmap
 */
router.patch("/:id", verifySupabaseJwt, writeLimiter, async (req, res, next) => {
  try {
    const { id } = req.params;
    const {
      name,
 ...
 */
router.delete("/:id", verifySupabaseJwt, writeLimiter, async (req, res, next) => {
  try {
    const { id } = req.params;
